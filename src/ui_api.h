...
IMPLEMENT_UI_WRAPPER(UISelectableFlag, (const char* text,bool& selected,ImGuiSelectableFlags flags), (text ,selected ,flags), (const char* ,bool& ,ImGuiSelectableFlags), bool)
...
IMPLEMENT_UI_VOID_WRAPPER(UIOpenPopup, (std::string popup,ImGuiPopupFlags flags), (popup ,flags), (std::string ,ImGuiPopupFlags))
IMPLEMENT_UI_WRAPPER(UIBeginPopup, (std::string popup,ImGuiPopupFlags flags), (popup ,flags), (std::string ,ImGuiPopupFlags), bool)
IMPLEMENT_UI_VOID_WRAPPER(UIEndPopup, (), (), ())
IMPLEMENT_UI_WRAPPER(UIBeginTable, (const char* id,int columns,ImGuiTableFlags flags), (id ,columns ,flags), (const char* ,int ,ImGuiTableFlags), bool)
IMPLEMENT_UI_VOID_WRAPPER(UIEndTable, (), (), ())
IMPLEMENT_UI_VOID_WRAPPER(UITableNextRow, (), (), ())
IMPLEMENT_UI_VOID_WRAPPER(UITableSetColumnIndex, (int index), (index), (int))
IMPLEMENT_UI_VOID_WRAPPER(UITableSetupColumn, (const char* text), (text), (const char*))
IMPLEMENT_UI_VOID_WRAPPER(UITableUploadHeaders, (), (), ())
IMPLEMENT_UI_VOID_WRAPPER(UISeparatorText, (const char* text), (text), (const char*))
IMPLEMENT_UI_VOID_WRAPPER(RenderLayerImpLRenderTextureProperty, (Electron::RenderLayer* layer,Electron::json_t& property,std::string label), (layer ,property ,label), (Electron::RenderLayer* ,Electron::json_t& ,std::string))
